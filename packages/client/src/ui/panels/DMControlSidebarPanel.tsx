/**
 * DMControlSidebarPanel - DM控制面板（侧边栏版）
 * 房主专用：回合推进、阶段切换、玩家管理
 *
 * 移除了就绪统计（已被 ReadyStatusFloat 替代）
 * 布局适配右下侧边栏
 */

import React, { useMemo } from "react";
import { Settings, ChevronDown, Users, UserX, Plus, Minus } from "lucide-react";
        ...
        <Flex direction="column" gap="2" style={{ height: "100%", overflowY: "auto", minHeight: 0 }}>
            ...
            <Box className="sidebar-edit-section">
                <Flex direction="column" gap="1">
                    <Flex align="center" justify="between" style={{ minHeight: 24 }}>
                        <Text size="1" style={{ color: "#6b8aaa" }}>回合</Text>
                        <Badge size="1">{turnCount}</Badge>
                    </Flex>
                    <Flex align="center" justify="between" style={{ minHeight: 24 }}>
                        <Text size="1" style={{ color: "#6b8aaa" }}>阶段</Text>
                        <Badge size="1" color="blue">{phase}</Badge>
                    </Flex>
                    {activeFaction && (
                        <Flex align="center" justify="between" style={{ minHeight: 24 }}>
                            <Text size="1" style={{ color: "#6b8aaa" }}>阵营</Text>
            ...
            <Box className="sidebar-edit-section">
                <Flex direction="column" gap="1">
                    <Text size="1" style={{ color: "#6b8aaa", marginBottom: 2 }}>阶段切换</Text>
                    <Flex gap="1" wrap="wrap">
                        <Button size="1" variant="soft" onClick={() => handleSetPhase("DEPLOYMENT")}>
                            部署
                        </Button>
                        <Button size="1" variant="soft" onClick={() => handleSetPhase("PLAYER_ACTION")}>
                            行动
                        </Button>
                        <Button size="1" variant="soft" onClick={() => handleSetPhase("DM_ACTION")}>
                            DM
                        </Button>
                    </Flex>
                </Flex>
            ...
            <Box className="sidebar-edit-section">
                <Flex direction="column" gap="1">
                    <Text size="1" style={{ color: "#6b8aaa", marginBottom: 2 }}>回合控制</Text>
                    <Flex gap="1">
            ...
            <Box className="sidebar-edit-section">
                <Flex direction="column" gap="1">
                    <Text size="1" style={{ color: "#6b8aaa", marginBottom: 2 }}>玩家管理</Text>
                    <DropdownMenu.Root>
