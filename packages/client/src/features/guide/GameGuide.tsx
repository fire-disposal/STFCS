...
import type { GamePhase, TurnPhase } from "@vt/types";
...
export class GuideManager {
	...
	private saveCompletedGuides(): void {
		try {
			localStorage.setItem("stfcs_completed_guides", JSON.stringify([...this.completedGuides]));
		} catch {
			// 忽略错误
		}
	}
...
export const GameGuide: React.FC<GameGuideProps> = ({ phase, guideManager, targetElement }) => {
