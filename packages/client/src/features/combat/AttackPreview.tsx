...
import type { AttackPreviewResult, DamageTypeValue } from "@vt/types";
...
export const AttackPreview: React.FC<AttackPreviewProps> = ({
	...
	if (!preview) {
		return (
			<div style={styles.container}>
				<div style={{ ...styles.header, ...styles.cannotAttack }}>加载预览中...</div>
			</div>
		);
	}
	...
	return (
		<div style={styles.container}>
			...
			>
				<span style={{ color: damageTypeColors[damageType] }}>攻击预览</span>
					...
					<div style={styles.previewSection}>
						...
						<div style={styles.damageList}>
							...
							<div style={styles.damageItem}>
								...
								<span style={styles.damageValue}>{preview.preview.hitQuadrant}</span>
							</div>
						</div>
					</div>
					...
					<div style={styles.previewSection}>
						...
						<div style={styles.fluxInfo}>
							...
							{preview.preview.willGenerateHardFlux && (
								<span style={{ color: "var(--color-warning)" }}>(产生硬辐能)</span>
							)}
						</div>
					</div>
				</>
