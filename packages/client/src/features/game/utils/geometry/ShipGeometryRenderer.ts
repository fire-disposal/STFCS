...
import type { ShipTokenV2 } from "@vt/types";
...
export function renderShipGeometry(
	...
	if (opts.isSelected) {
		...
		drawDashedCircle(selectionGraphics, 0, 0, token.visual.collisionRadius + 10, 0x00ff88, 0.8);
...
export { HULL_SIZE_COLORS, DAMAGE_TYPE_COLORS, STATUS_COLORS };
