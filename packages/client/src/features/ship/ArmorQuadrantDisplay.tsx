	...
	return (
		<div style={styles.container}>
			<div style={styles.header}>
				<span>🛡️ 装甲系统</span>
				<span style={{ fontSize: "9px", color: "#8ba4c7" }}>平均 {averagePercent.toFixed(0)}%</span>
			</div>
				...
				{QUADRANT_NAMES.map((name, index) => {
					...
					return (
						<div key={index} style={styles.quadrantItem}>
							<div style={styles.quadrantName}>{name}</div>
							<div
								style={{
			...
			{/* 提示信息 */}
			<div style={styles.hint}>💡 护甲值影响伤害减免，优先保护高威胁方向</div>
		</div>
	);
};
