...
import { addMessage, addSystemMessage, clearUnreadCount, type ChatMessage } from '@/store/slices/chatSlice';
      ...
      <div style={styles.messageList}>
        {chatState.messages.length === 0 ? (
          <div style={styles.emptyState}>
            暂无消息
            <br />
            <span style={{ fontSize: '10px', color: '#4a5a6a' }}>
              按 Enter 发送消息
            </span>
          </div>
        ) : (
          // 只显示最近 MAX_MESSAGES 条消息
          chatState.messages.slice(-MAX_MESSAGES).map((msg: ChatMessage) => (
